...
2b. `aad growth --json` — fill rate (GB/h, GB/day), ETA to the free-space floor, and which watched paths are growing. `--sample` seeds the hotspot ledger; growers need two snapshots ≥1h apart.
